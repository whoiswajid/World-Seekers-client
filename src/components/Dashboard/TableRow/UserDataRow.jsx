        ...
        <tr>
            ...
            <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
                {user?.status ? (
                    ...
                    <p className='text-blue-500 whitespace-no-wrap'>Unavailable</p>
                )}
            </td>
            ...
            <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
               ...
               <UpdateUserModal isOpen={isOpen} setIsOpen={setIsOpen} user={useState} modalHandler={modalHandler}></UpdateUserModal>
            </td>
        </tr>
    )
}
